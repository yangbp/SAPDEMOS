...
public section.
*"* public components of class CL_DEMO_AREA
*"* do not include other source files here!!!

  constants AREA_NAME type SHM_AREA_NAME value 'CL_DEMO_AREA'. "#EC NOTEXT
  data ROOT type ref to CL_DEMO_ROOT read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to CL_DEMO_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods GET_ROOT
    redefinition .
protected section.
*"* protected components of class CL_DEMO_AREA
*"* do not include other source files here!!!
private section.
*"* private components of class CL_DEMO_AREA
*"* do not include other source files here!!!

  constants _VERSION_ type I value 19. "#EC NOTEXT
...
CLASS CL_DEMO_AREA IMPLEMENTATION.
