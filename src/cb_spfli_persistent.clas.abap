class CB_SPFLI_PERSISTENT definition
  public
  inheriting from CL_OS_CA_COMMON
  abstract
  create public .

*"* public components of class CB_SPFLI_PERSISTENT
*"* do not include other source files here!!!
public section.

  methods CREATE_PERSISTENT
    importing
      !I_AIRPFROM type S_FROMAIRP optional
      !I_AIRPTO type S_TOAIRP optional
      !I_ARRTIME type S_ARR_TIME optional
      !I_CARRID type S_CARR_ID
      !I_CITYFROM type S_FROM_CIT optional
      !I_CITYTO type S_TO_CITY optional
      !I_CONNID type S_CONN_ID
      !I_COUNTRYFR type LAND1 optional
      !I_COUNTRYTO type LAND1 optional
      !I_DEPTIME type S_DEP_TIME optional
      !I_DISTANCE type S_DISTANCE optional
      !I_DISTID type S_DISTID optional
      !I_FLTIME type S_FLTIME optional
      !I_FLTYPE type S_FLTYPE optional
      !I_PERIOD type S_PERIOD optional
    returning
      value(RESULT) type ref to CL_SPFLI_PERSISTENT
    raising
  ...
  methods IF_OS_FACTORY~CREATE_TRANSIENT_BY_KEY
    redefinition .
protected section.
*"* protected components of class CB_SPFLI_PERSISTENT
*"* do not include other source files here!!!

  types TYP_OID type OS_GUID .
  types TYP_TYPE type OS_GUID .
  types TYP_OBJECT_REF type ref to CL_SPFLI_PERSISTENT .
  types:
  ...
  types TYP_LPORU type SIBFLPORU .
  ...
  methods SAVE_SPECIAL_OBJECT_INFO
    redefinition .
private section.
*"* private components of class CB_SPFLI_PERSISTENT
*"* do not include other source files here!!!
ENDCLASS.



CLASS CB_SPFLI_PERSISTENT IMPLEMENTATION.
...
*      IMPORTING I_AIRPFROM TYPE S_FROMAIRP
*      IMPORTING I_AIRPTO TYPE S_TOAIRP
*      IMPORTING I_ARRTIME TYPE S_ARR_TIME
*      IMPORTING I_CITYFROM TYPE S_FROM_CIT
*      IMPORTING I_CITYTO TYPE S_TO_CITY
*      IMPORTING I_COUNTRYFR TYPE LAND1
*      IMPORTING I_COUNTRYTO TYPE LAND1
*      IMPORTING I_DEPTIME TYPE S_DEP_TIME
*      IMPORTING I_DISTANCE TYPE S_DISTANCE
*      IMPORTING I_DISTID TYPE S_DISTID
*      IMPORTING I_FLTIME TYPE S_FLTIME
*      IMPORTING I_FLTYPE TYPE S_FLTYPE
*      IMPORTING I_PERIOD TYPE S_PERIOD
*      RETURNING RESULT TYPE REF TO CL_SPFLI_PERSISTENT
************************************************************************
...
*<  Generated from mapping:
          ...
          THE_OBJECT->AIRPFROM = I_AIRPFROM.
          THE_OBJECT->AIRPTO = I_AIRPTO.
          THE_OBJECT->ARRTIME = I_ARRTIME.
          THE_OBJECT->CITYFROM = I_CITYFROM.
          THE_OBJECT->CITYTO = I_CITYTO.
          THE_OBJECT->COUNTRYFR = I_COUNTRYFR.
          THE_OBJECT->COUNTRYTO = I_COUNTRYTO.
          THE_OBJECT->DEPTIME = I_DEPTIME.
          THE_OBJECT->DISTANCE = I_DISTANCE.
          THE_OBJECT->DISTID = I_DISTID.
          THE_OBJECT->FLTIME = I_FLTIME.
          THE_OBJECT->FLTYPE = I_FLTYPE.
          THE_OBJECT->PERIOD = I_PERIOD.
*>
...
*   * internal Undo
    ...
    try.
        ...
        loop at OBJECT_DATA_TAB assigning <FS_OBJECT_DATA>.
          ...
          loop at I_KEY_TAB assigning <FS_BUSINESS_KEY>. "#EC GEN_OK
            if <FS_BUSINESS_KEY> = BUSINESS_KEY.

              TEMP_OBJECT_REF ?= CURRENT_OBJECT_IREF.
              modify RESULT from TEMP_OBJECT_REF index sy-tabix.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to CL_SPFLI_PERSISTENT,
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-AIRPFROM = THE_OBJECT->AIRPFROM.
    OBJECT_DATA_ITEM-AIRPTO = THE_OBJECT->AIRPTO.
    OBJECT_DATA_ITEM-ARRTIME = THE_OBJECT->ARRTIME.
    OBJECT_DATA_ITEM-CARRID = THE_OBJECT->CARRID.
    OBJECT_DATA_ITEM-CITYFROM = THE_OBJECT->CITYFROM.
    OBJECT_DATA_ITEM-CITYTO = THE_OBJECT->CITYTO.
    OBJECT_DATA_ITEM-CONNID = THE_OBJECT->CONNID.
    OBJECT_DATA_ITEM-COUNTRYFR = THE_OBJECT->COUNTRYFR.
    OBJECT_DATA_ITEM-COUNTRYTO = THE_OBJECT->COUNTRYTO.
    OBJECT_DATA_ITEM-DEPTIME = THE_OBJECT->DEPTIME.
    OBJECT_DATA_ITEM-DISTANCE = THE_OBJECT->DISTANCE.
    OBJECT_DATA_ITEM-DISTID = THE_OBJECT->DISTID.
    OBJECT_DATA_ITEM-FLTIME = THE_OBJECT->FLTIME.
    OBJECT_DATA_ITEM-FLTYPE = THE_OBJECT->FLTYPE.
    OBJECT_DATA_ITEM-PERIOD = THE_OBJECT->PERIOD.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'AIRPFROM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'AIRPFROM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'AIRPTO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'AIRPTO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ARRTIME'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ARRTIME'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CITYFROM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CITYFROM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CITYTO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CITYTO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'COUNTRYFR'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'COUNTRYFR'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'COUNTRYTO'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'COUNTRYTO'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'DEPTIME'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'DEPTIME'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'DISTANCE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'DISTANCE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'DISTID'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'DISTID'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'FLTIME'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'FLTIME'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'FLTYPE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'FLTYPE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PERIOD'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'SPFLI'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PERIOD'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO CL_SPFLI_PERSISTENT.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->AIRPFROM,
             ...
             THE_OBJECT->CITYTO,
             THE_OBJECT->CONNID,
             THE_OBJECT->COUNTRYFR,
             THE_OBJECT->COUNTRYTO,
             THE_OBJECT->DEPTIME,
             THE_OBJECT->DISTANCE,
             THE_OBJECT->DISTID,
             THE_OBJECT->FLTIME,
...
*>
  ...
  data: DB_DATA           type TYP_DB_DATA,
        DB_DATA_LOCAL_TAB type TYP_DB_DATA_LOCAL_TAB.

  field-symbols: <FS_DB_DATA_LOCAL> type TYP_DB_DATA_LOCAL.

*< Generated from mapping:
  field-symbols: <FS_DB_SPFLI> type SPFLI.
*>
...
*   * error handling
  ...
  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.
    ...
    assign <FS_DB_DATA_LOCAL>-DB_ITEM_SPFLI to <FS_DB_SPFLI>.

*< Generated from mapping:
    DB_DATA-AIRPFROM = <FS_DB_SPFLI>-AIRPFROM.
    DB_DATA-AIRPTO = <FS_DB_SPFLI>-AIRPTO.
    DB_DATA-ARRTIME = <FS_DB_SPFLI>-ARRTIME.
    DB_DATA-CARRID = <FS_DB_SPFLI>-CARRID.
    DB_DATA-CITYFROM = <FS_DB_SPFLI>-CITYFROM.
    DB_DATA-CITYTO = <FS_DB_SPFLI>-CITYTO.
    DB_DATA-CONNID = <FS_DB_SPFLI>-CONNID.
    DB_DATA-COUNTRYFR = <FS_DB_SPFLI>-COUNTRYFR.
    DB_DATA-COUNTRYTO = <FS_DB_SPFLI>-COUNTRYTO.
    DB_DATA-DEPTIME = <FS_DB_SPFLI>-DEPTIME.
    DB_DATA-DISTANCE = <FS_DB_SPFLI>-DISTANCE.
    DB_DATA-DISTID = <FS_DB_SPFLI>-DISTID.
    DB_DATA-FLTIME = <FS_DB_SPFLI>-FLTIME.
    DB_DATA-FLTYPE = <FS_DB_SPFLI>-FLTYPE.
    DB_DATA-PERIOD = <FS_DB_SPFLI>-PERIOD.
*>
...
*< Generated from mapping:
  select * from SPFLI
           ...
           where SPFLI~CARRID = I_BUSINESS_KEY_TAB-CARRID
             and SPFLI~CONNID = I_BUSINESS_KEY_TAB-CONNID.
*>
...
* * SPFLI: internal tables for mass operation
  data DB_ITB_SPFLI type STANDARD TABLE OF SPFLI.
  data DB_UTB_SPFLI type STANDARD TABLE OF SPFLI.
  data DB_DTB_SPFLI type STANDARD TABLE OF SPFLI.

* * SPFLI: headlines for tables
  data DB_ILN_SPFLI type SPFLI.
  data DB_ULN_SPFLI type SPFLI.
  data DB_DLN_SPFLI type SPFLI.
...
*< Generated from mapping:
   ...
   DB_ILN_SPFLI-AIRPFROM = <FS_INSERT>-AIRPFROM.
   DB_ILN_SPFLI-AIRPTO = <FS_INSERT>-AIRPTO.
   DB_ILN_SPFLI-ARRTIME = <FS_INSERT>-ARRTIME.

   DB_ILN_SPFLI-CITYFROM = <FS_INSERT>-CITYFROM.
   DB_ILN_SPFLI-CITYTO = <FS_INSERT>-CITYTO.

   DB_ILN_SPFLI-COUNTRYFR = <FS_INSERT>-COUNTRYFR.
   DB_ILN_SPFLI-COUNTRYTO = <FS_INSERT>-COUNTRYTO.
   DB_ILN_SPFLI-DEPTIME = <FS_INSERT>-DEPTIME.
   DB_ILN_SPFLI-DISTANCE = <FS_INSERT>-DISTANCE.
   DB_ILN_SPFLI-DISTID = <FS_INSERT>-DISTID.
   DB_ILN_SPFLI-FLTIME = <FS_INSERT>-FLTIME.
   DB_ILN_SPFLI-FLTYPE = <FS_INSERT>-FLTYPE.
   DB_ILN_SPFLI-PERIOD = <FS_INSERT>-PERIOD.


   DB_ILN_SPFLI-CARRID = <FS_INSERT>-CARRID.
   DB_ILN_SPFLI-CONNID = <FS_INSERT>-CONNID.
   append DB_ILN_SPFLI to DB_ITB_SPFLI.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_SPFLI-AIRPFROM = <FS_UPDATE>-AIRPFROM.
   DB_ULN_SPFLI-AIRPTO = <FS_UPDATE>-AIRPTO.
   DB_ULN_SPFLI-ARRTIME = <FS_UPDATE>-ARRTIME.

   DB_ULN_SPFLI-CITYFROM = <FS_UPDATE>-CITYFROM.
   DB_ULN_SPFLI-CITYTO = <FS_UPDATE>-CITYTO.

   DB_ULN_SPFLI-COUNTRYFR = <FS_UPDATE>-COUNTRYFR.
   DB_ULN_SPFLI-COUNTRYTO = <FS_UPDATE>-COUNTRYTO.
   DB_ULN_SPFLI-DEPTIME = <FS_UPDATE>-DEPTIME.
   DB_ULN_SPFLI-DISTANCE = <FS_UPDATE>-DISTANCE.
   DB_ULN_SPFLI-DISTID = <FS_UPDATE>-DISTID.
   DB_ULN_SPFLI-FLTIME = <FS_UPDATE>-FLTIME.
   DB_ULN_SPFLI-FLTYPE = <FS_UPDATE>-FLTYPE.
   DB_ULN_SPFLI-PERIOD = <FS_UPDATE>-PERIOD.


   DB_ULN_SPFLI-CARRID = <FS_UPDATE>-CARRID.
   DB_ULN_SPFLI-CONNID = <FS_UPDATE>-CONNID.
   append DB_ULN_SPFLI TO DB_UTB_SPFLI.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_SPFLI-CARRID = <FS_DELETE>-BUSINESS_KEY-CARRID.
    DB_DLN_SPFLI-CONNID = <FS_DELETE>-BUSINESS_KEY-CONNID.

    append DB_DLN_SPFLI TO DB_DTB_SPFLI.
...
* * DB Deletes
  delete SPFLI FROM TABLE DB_DTB_SPFLI.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert SPFLI FROM TABLE DB_ITB_SPFLI
...
* * DB Updates
  update SPFLI FROM TABLE DB_UTB_SPFLI.
  if SY-SUBRC <> 0.
...
*<  Generated from mapping:
  THE_OBJECT->AIRPFROM = I_OBJECT_DATA-AIRPFROM.
  THE_OBJECT->AIRPTO = I_OBJECT_DATA-AIRPTO.
  THE_OBJECT->ARRTIME = I_OBJECT_DATA-ARRTIME.
  THE_OBJECT->CARRID = I_OBJECT_DATA-CARRID.
  THE_OBJECT->CITYFROM = I_OBJECT_DATA-CITYFROM.
  THE_OBJECT->CITYTO = I_OBJECT_DATA-CITYTO.
  THE_OBJECT->CONNID = I_OBJECT_DATA-CONNID.
  THE_OBJECT->COUNTRYFR = I_OBJECT_DATA-COUNTRYFR.
  THE_OBJECT->COUNTRYTO = I_OBJECT_DATA-COUNTRYTO.
  THE_OBJECT->DEPTIME = I_OBJECT_DATA-DEPTIME.
  THE_OBJECT->DISTANCE = I_OBJECT_DATA-DISTANCE.
  THE_OBJECT->DISTID = I_OBJECT_DATA-DISTID.
  THE_OBJECT->FLTIME = I_OBJECT_DATA-FLTIME.
  THE_OBJECT->FLTYPE = I_OBJECT_DATA-FLTYPE.
  THE_OBJECT->PERIOD = I_OBJECT_DATA-PERIOD.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to CL_SPFLI_PERSISTENT.
