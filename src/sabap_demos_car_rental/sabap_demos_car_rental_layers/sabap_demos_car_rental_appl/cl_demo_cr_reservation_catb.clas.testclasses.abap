...
CLASS lcl_test_reservation_catb DEFINITION FOR TESTING
                                INHERITING FROM cl_demo_cr_test_reservation
                                DURATION SHORT
                                RISK LEVEL HARMLESS
                                FINAL.
  PRIVATE SECTION.
    METHODS test_make_reservation_catb FOR TESTING.
ENDCLASS.

CLASS lcl_test_reservation_catb IMPLEMENTATION.
  METHOD test_make_reservation_catb.
    ...
    cl_aunit_assert=>assert_equals(
      EXPORTING
        ...
        act                  =     20 * cl_demo_cr_reservation_catb=>catb_rate
        msg                  =     'Wrong price' ).
  ENDMETHOD.
ENDCLASS.
