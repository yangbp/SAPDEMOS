...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'CL_DEMO_FLIGHTS'. "#EC NOTEXT
  data ROOT type ref to CL_DEMO_FLIGHT_LIST read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to CL_DEMO_FLIGHTS
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to CL_DEMO_FLIGHT_LIST
    raising
...
private section.
  ...
  constants _VERSION_ type I value 20. "#EC NOTEXT
...
CLASS CL_DEMO_FLIGHTS IMPLEMENTATION.
